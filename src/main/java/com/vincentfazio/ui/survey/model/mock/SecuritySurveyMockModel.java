...
public class SecuritySurveyMockModel implements SecuritySurveyModel {
    ...
    @Override
    public void getQuestions(String companyId, AsyncCallback<List<QuestionBean>> asyncCallback) {
        List<QuestionBean> questionList = surveyQuestions.get(companyId);
        if (null == questionList) {
            questionList = createDefaultQuestionSet(companyId);
            surveyQuestions.put(companyId, questionList);
        } 
	...
	private void updateRequestedDocumentation(String companyId, QuestionBean question) {
		...
		if (question.isAnswered()) {
			...
			taskModel.updateDocumentationTask(companyId, selectedDocumentation);
		}
	}

    @Override
    public void getQuestion(String companyId, QuestionBean question, AsyncCallback<QuestionBean> asyncCallback) {
        List<QuestionBean> questionList = surveyQuestions.get(companyId);
    ...
    public void answerQuestion(String companyId, QuestionBean response, AsyncCallback<String> asyncCallback) {
        ...
        updateRequestedDocumentation(companyId, response);
    ...
    private List<QuestionBean> createDefaultQuestionSet(String companyId) {
    	List<QuestionBean> questionList = parser.parse(SecuritySurveyXml);
        for (QuestionBean question: questionList) {
            updateRequestedDocumentation(companyId, question);
        }
        return questionList;
