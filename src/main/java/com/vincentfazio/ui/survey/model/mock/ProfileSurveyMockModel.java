...
public class ProfileSurveyMockModel implements ProfileSurveyModel {

    private Map<String, List<QuestionBean>> surveyQuestions = new HashMap<String, List<QuestionBean>>();
    private ProfileSurveyXmlParser parser = new ProfileSurveyXmlParser();
    
    public ProfileSurveyMockModel() {
        super();
    }
    ...
    public void getQuestions(String companyId, AsyncCallback<List<QuestionBean>> asyncCallback) {
        ...
        if (null == questionList) {
            questionList = createDefaultQuestionSet();
    ...
    private List<QuestionBean> createDefaultQuestionSet() {
        return parser.parse(profileSurveyXml);
    }
