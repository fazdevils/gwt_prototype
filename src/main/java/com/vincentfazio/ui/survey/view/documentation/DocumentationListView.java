...
public class DocumentationListView extends Composite implements DocumentationListDisplay, DataProviderSearchBoxUpdateCallback {
    ...
    public DocumentationListView() {
        ...
        GwtSurveyGlobals.getInstance().registerDisplay(DocumentationListDisplay.class, this);
    }
    ...
    public void showView(DocumentationDeckEnum documentationView) {
        CompanyHomeDisplay navigationDisplay = (CompanyHomeDisplay) GwtSurveyGlobals.getInstance().getDisplay(CompanyHomeDisplay.class);
        navigationDisplay.showView(CompanyDeckEnum.Documentation);
    ...
    public void handleSearchBoxChange() {
        ...
        List<DocumentationBean> companyList = documentationDataProvider.getList();
	...
	public String getCompanyId() {
		return documentationDetails.getCompanyId();
	}

	@Override
	public void setCompanyId(String companyId) {
		documentationDetails.setCompanyId(companyId);
