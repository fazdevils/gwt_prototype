...
public class ProfileSurveyView extends Composite implements ProfileSurveyDisplay {
    ...
    public ProfileSurveyView() {
        ...
        selectionModel.addSelectionChangeHandler(new SelectionChangeEvent.Handler() {
            public void onSelectionChange(SelectionChangeEvent event) {
                ...
                GwtSurveyGlobals.getInstance().gotoPlace(new ProfileSurveyPlace(getCompanyId(), selectedQuestion));
            }
        });
        ...
        companySelector = new CompanySelectorView(new CompanySelectorView.CompanySelectionHandler() {           
            ...
            public void handleCompanyChange(String companyId) {               
                GwtSurveyGlobals.getInstance().gotoPlace(new ProfileSurveyPlace(companyId, null));
            }
        }, CompanyAccessDisplayType.ProfileSurvey);
        ...
        GwtSurveyGlobals.getInstance().registerDisplay(ProfileSurveyDisplay.class, this);        
    ...
    private boolean openSurveyTask(TaskBean task) {
        return task.getTaskType().equals(TaskType.ProfileSurvey) && task.getCompany().equals(getCompanyId());
    }
