...
import com.vincentfazio.ui.vendor.model.mock.ProfileSurveyMockModel;
import com.vincentfazio.ui.vendor.model.mock.SecuritySurveyMockModel;
...
public class GwtVendorGlobals extends GwtGlobals {
    
    protected static GwtVendorGlobals instance = null;
    public static GwtGlobals getInstance() {
        if (null == instance) {
            synchronized (GwtVendorGlobals.class) {
                if (null == instance) {
                    instance = new GwtVendorGlobals();
                }
            }
        }
        return instance;
