...
import com.vincentfazio.ui.vendor.activity.ProfileSurveyQuestionActivity;
import com.vincentfazio.ui.vendor.activity.ProfileSurveyQuestionSaveActivity;
    ...
    public ProfileSurveyQuestionView() {
        ...
        undoButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                new ProfileSurveyQuestionActivity(vendorId, question, GwtVendorGlobals.getInstance()).start(null, null);
            }
        });
        ...
        saveButton.addClickHandler(new ClickHandler() {
            @Override
            public void onClick(ClickEvent event) {
                new ProfileSurveyQuestionSaveActivity(vendorId, getQuestion(), GwtVendorGlobals.getInstance()).start(null, null);
            }
        });       
        
        GwtVendorGlobals.getInstance().registerDisplay(ProfileSurveyQuestionDisplay.class, this);
