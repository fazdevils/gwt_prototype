...
public class SecuritySurveyView extends Composite implements SecuritySurveyDisplay {
    ...
    public SecuritySurveyView() {
        ...
        selectionModel.addSelectionChangeHandler(new SelectionChangeEvent.Handler() {
            public void onSelectionChange(SelectionChangeEvent event) {
                ...
                GwtVendorGlobals.getInstance().gotoPlace(new SecuritySurveyPlace(getVendorId(), selectedQuestion));
            }
        });
        ...
        vendorSelector = new VendorSelectorView(new VendorSelectorView.VendorSelectionHandler() {           
            ...
            public void handleVendorChange(String vendorId) {               
                GwtVendorGlobals.getInstance().gotoPlace(new SecuritySurveyPlace(vendorId, null));
            }
        }, VendorAccessDisplayType.SecuritySurvey);
        ...
        GwtVendorGlobals.getInstance().registerDisplay(SecuritySurveyDisplay.class, this);        
    ...
    private boolean openSurveyTask(TaskBean task) {
        return task.getTaskType().equals(TaskType.SecuritySurvey) && task.getVendor().equals(getVendorId());
    }
