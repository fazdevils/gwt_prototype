...
import com.vincentfazio.ui.vendor.activity.SecuritySurveyQuestionActivity;
import com.vincentfazio.ui.vendor.activity.SecuritySurveyQuestionSaveActivity;
import com.vincentfazio.ui.vendor.global.GwtVendorGlobals;
import com.vincentfazio.ui.vendor.view.component.ChooseManyButtonComponent;
import com.vincentfazio.ui.vendor.view.component.ChooseOneRadioButtonComponent;
import com.vincentfazio.ui.vendor.view.component.TrueFalseButtonComponent;
...
public class SecuritySurveyQuestionView extends Composite implements SecuritySurveyQuestionDisplay {
    ...
    public SecuritySurveyQuestionView() {
        ...
        undoButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                new SecuritySurveyQuestionActivity(vendorId, question, GwtVendorGlobals.getInstance()).start(null, null);
            }
        });
        ...
        saveButton.addClickHandler(new ClickHandler() {
            @Override
            public void onClick(ClickEvent event) {
                new SecuritySurveyQuestionSaveActivity(vendorId, getQuestion(), GwtVendorGlobals.getInstance()).start(null, null);
            }
        });       
        
        GwtVendorGlobals.getInstance().registerDisplay(SecuritySurveyQuestionDisplay.class, this);
    ...
    @Override
    public void setQuestion(String vendorId, QuestionBean question) {
